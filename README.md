...
* [x] Verify your compiler is working correctly by changing the `background-color` on the `html` selector to --`red`-- `peachpuff`
* [x] Once you see the --red-- peachpuff screen, you can delete that style and you're ready to start on the next task
...
**per the guidance form today's lecture, I used this as inspiration https://www.canva.com/design/DAD0SlyBpEM/4-mYXY08C6nl7VnUvXAgpQ/edit?category=tACZCki4tbY**
